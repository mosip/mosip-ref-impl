...
public class SwaggerConfig {
	...
	public OpenAPI openApi() {
		...
		if (null != openApiProperties.getRegistrationProcessorExternalIntegrationService().getServers()) {
			openApiProperties.getRegistrationProcessorExternalIntegrationService().getServers().forEach(server -> {
