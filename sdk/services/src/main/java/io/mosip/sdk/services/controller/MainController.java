package io.mosip.sdk.services.controller;
...
import io.mosip.sdk.common.dto.*;
import io.mosip.sdk.services.config.LoggerConfig;
...
public class MainController {
    ...
    public ResponseEntity<SDKInfo> init(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(iBioApi.init(request.getInitParams()));
    }
    ...
    public ResponseEntity<BiometricRecord> convertFormat(
