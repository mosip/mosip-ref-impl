package io.mosip.sdk.services.config;
...
public class BioSdkLibConfig {
    ...
    public void validateBioSdkLib() throws ClassNotFoundException {
        if (StringUtils.isNotBlank(this.env.getProperty("mosip.sdk.biosdk.lib"))) {
            logger.debug("validating Bio SDK Class is present or not");
            Class.forName(this.env.getProperty("mosip.sdk.biosdk.lib"));
        }
    ...
    public IBioApi iBioApi() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        if (StringUtils.isNotBlank(this.env.getProperty("mosip.sdk.biosdk.lib"))) {
            ...
            return (IBioApi)Class.forName(this.env.getProperty("mosip.sdk.biosdk.lib")).newInstance();
        } else {
