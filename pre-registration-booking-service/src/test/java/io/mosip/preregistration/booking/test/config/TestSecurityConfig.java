// package io.mosip.preregistration.booking.test.config;
...
// 		users.add(new User("PRE_REGISTRATION_ADMIN", "mosip", Arrays.asList(new SimpleGrantedAuthority("ROLE_PRE_REGISTRATION_ADMIN"))));
