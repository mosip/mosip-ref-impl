### -- ---------------------------------------------------------------------------------------------------------
### -- Script Name		: ARCHIVE DB Artifacts deploy
### -- Deploy Module 	: MOSIP ARCHIVE DAtabase
### -- Purpose    		: To deploy MOSIP ARCHIVE Database DB Artifacts.       
...
#========================================DB Deployment process begins on ARCHIVE DB SERVER======================================
...
then
    ...
    echo `date "+%m/%d/%Y %H:%M:%S"` ": Registration Device database user already exist" | tee -a $LOG 2>&1
fi
...
#========================================DB Deployment process completes on ARCHIVE DB SERVER======================================
