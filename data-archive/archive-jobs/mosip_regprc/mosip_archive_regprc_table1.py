#-- -------------------------------------------------------------------------------------------------
#-- Job Name        : Registration Processor DB Tables Archive
#-- DB Name 	    : mosip_regprc
#-- Table Names     : registration_transaction
#-- Purpose    	    : Job to Archive Data in registration processor DB for above mentioned tables         
#-- Create By       : Sadanandegowda DM
#-- Created Date    : Dec-2020
#-- 
#-- Modified Date       Modified By         	Comments / Remarks
#-- Sept-2021		Chandra Keshav Mishra	Updated getValue funtion
#-- ------------------------------------------------------------------------------------------
#-- 
#-- ------------------------------------------------------------------------------------------
...
def config(filename='mosip_archive_regprc.ini', section='MOSIP-DB-SECTION'):
    parser = ConfigParser()
